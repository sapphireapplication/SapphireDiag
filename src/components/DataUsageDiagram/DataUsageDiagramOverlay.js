...
export default function DataUsageDiagramOverlay(props) {
  const { classes } = props;
...
//   }
  ...
  return props.DUDProgramData.DUDProgramData==""?null: (
    <div
      id="dudmaincontainer" style={{left : "230px", top: "85px", position: "absolute",backgroundColor: "white"}}>
...
//Data Usage Diagram {props.DUDProgramData.program === ""?null: props.DUDProgramData.program.value==="default"?"":props.DUDProgramData.program.value}
//</span>